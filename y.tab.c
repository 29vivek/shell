...
{
       0,    22,    22,    26,    27,    31,    35,    39,    43,    47,
      48,    53,    59,    60,    64,    71,    79,    80,    84,    90,
      96,   103,   110,   117,   120
};
#endif
...
static const char *const yytname[] =
{
  ...
  "LESS", "PIPE", "AMPERSAND", "GREATGREAT", "GREATGREATAMPERSAND",
  "GREATAMPERSAND", "$accept", "goal", "commands", "command",
  "simple_command", "pipe_list", "command_and_args", "arg_list",
  "argument", "command_word", "iomodifier_list", "iomodifier",
...
{
       8,    -3,    -7,    -7,    14,     7,    -7,    -7,     9,    -7,
      -7,    -7,    -7,    -7,    12,    -6,    13,    -7,    15,    16,
...
{
      18,    19,    11,    20,    21,    22,    23,    -2,     1,     1,
       2,     2,     3,     3,    12,     2,    26,    14,    28,    29,
      30,    31,    32,     0,    17,    33,    13
};

static const yytype_int8 yycheck[] =
{
       6,     7,     5,     9,    10,    11,    12,     0,     1,     1,
       3,     3,     5,     5,     0,     3,     3,     8,     3,     3,
       3,     3,     3,    -1,    14,     5,     5
};
